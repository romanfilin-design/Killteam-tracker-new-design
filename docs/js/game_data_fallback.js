    ...
    "Canoptek Circle": [
      {
        ...
        "uses": 1,
        "usesLabel": "1× за битву",
        "desc": "Одним движением пальцев умелый Geomancer может использовать этот усовершенствованный geomantic manipulator как суррогатный obelisk node, чтобы расширить матрицу.\n\nOnce per battle, во время активации или counteraction дружественного оператора CANOPTEK CIRCLE можно использовать это правило. Если используешь, до конца той активации/counteraction дружественный оператор CANOPTEK CIRCLE GEOMANCER считается твоим четвёртым маркером OBELISK NODE."
      },
      {
        "id": "awakened_obelisk_nodes",
        "name": "Awakened Obelisk Nodes",
        "uses": null,
        "usesLabel": "D3× за битву (см. текст)",
        "desc": "Заложенные заранее и активированные давным-давно, эти obelisk nodes накопили огромные запасы локальных данных, готовые наделить своего владельца превосходством, когда придёт время.\n\nПосле того как это снаряжение раскрыто, брось один D3. Можно использовать firefight ploy Animate Obelisk Nodes за 0CP количество раз за битву, равное результату."
      },
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Эти небольшие устройства выпускают клубы призрачного пара. На самом деле это облака крошечных ремонтных конструктов, запечатывающих разрывы в живом металле.\n\nКаждый раз, когда дружественный оператор CANOPTEK CIRCLE активируется, он восстанавливает до D3 потерянных wounds."
      },
      {
        "id": "phase_shifter",
        "name": "Phase Shifter",
        "uses": 1,
        "usesLabel": "1× за turning point",
        "desc": "Форма носителя мерцает между измерениями, словно призрак, из-за чего нанести по нему точный удар крайне трудно.\n\nOnce per turning point, когда оператор стреляет по дружественному оператору CANOPTEK CIRCLE GEOMANCER, в начале этапа Roll Defence Dice можно использовать это правило. Если используешь, ухудши x weapon rule Piercing на 1 (если есть) до конца этой последовательности. Учти, что Piercing 1 в этом случае будет проигнорирован."
      }
    ],
    "Ratlings": [
      {
        ...
        "uses": 1,
        "usesLabel": "1× за turning point",
        "desc": "Once per turning point, когда дружественный оператор RATLING стреляет с rifle и ты бросил свои attack dice, можно использовать это правило. Если делаешь это: улучши Hit stat этого rifle на 1 до конца этой sequence. Это позволяет применить изменение Hit stat во время действия (это имеет приоритет над core rules)."
      },
      {
        "id": "lucky_round",
        "name": "Lucky Round",
        "uses": 1,
        "usesLabel": "1× за turning point",
        "desc": "Once per turning point, когда дружественный оператор RATLING стреляет с rifle и ты бросил свои attack dice, можно использовать это правило. Если делаешь это: то оружие получает weapon rule Severe до конца этой sequence."
      },
      {
        "id": "stolen_goods",
        "name": "Stolen Goods",
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "В конце шага Select Operatives брось один D3. Если результат:\n• 1 — ты теряешь 1CP.\n• 2 — ты получаешь 1CP.\n• 3 — твой оппонент теряет 1CP."
      },
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Каждый раз, когда оператор стреляет по дружественному оператору RATLING BULLGRYN или дружественному оператору RATLING OGRYN, результаты defence dice 5+ становятся critical successes."
      }
    ],
    "Elucidian Starstriders": [
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Каждый раз, когда оператор стреляет по дружественному оператору ELUCIDIAN STARSTRIDER (кроме CANID) с характеристикой Save 5+, можно удержать один из результатов defence dice 4 как normal success."
      },
      {
        ...
        "uses": 2,
        "usesLabel": "2× за turning point",
        "desc": "До двух раз за turning point, когда дружественный оператор ELUCIDIAN STARSTRIDER выполняет действие Shoot и выбирает laspistol, lasgun или relic laspistol, можно использовать это правило. Если используешь: до конца turning point добавь 1 к обеим характеристикам Dmg того оружия, и оно получает weapon rules Hot и Piercing Crits 1."
      },
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Каждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER использует PRIVATEER SUPPORT ASSET, если цель в пределах 6\" от дружественного оператора ELUCIDIAN STARSTRIDER NAVIS, цель не может быть obscured, и то оружие получает weapon rule Saturate."
      },
      {
        "id": "rapid_gunnery",
        "name": "Rapid Gunnery",
        "uses": 1,
        "usesLabel": "1× за битву",
        "desc": "Один раз за битву, при выборе PRIVATEER SUPPORT ASSET можно выбрать тот, что уже был использован в этой битве. Это имеет приоритет над обычными правилами PRIVATEER SUPPORT ASSET."
      }
    ],
    "Blooded": [
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Тревожащие знаки, которые носят Blooded, искривляют реальность и истончают завесу между явью и переменчивыми течениями варпа.\n\nFirefight ploy Reward Earned стоит тебе 0CP."
      },
      {
        ...
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Blooded украшают свою броню отрубленными головами на ржавых пиках, плащами и накидками из содранной кожи и прочими жуткими трофеями с тел своих жертв.\n\nКаждый раз, когда вражеский оператор стреляет по, дерётся против или отвечает (retaliating) против дружественного оператора BLOODED с твоим токеном Blooded и в пределах 2\" от него, твой оппонент не может перебрасывать результаты attack dice равные 1."
      },
      {
        "id": "symbols_of_bloody_worship",
        "name": "Symbols of Bloody Worship",
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Отчаянно жаждущие благосклонности малефичных сущностей варпа, Blooded наносят на броню кровавые руны и идут на риск, чтобы впитать частицу злобной силы.\n\nКаждый раз, когда дружественный оператор BLOODED заканчивает действие, если он не был выведен из строя, но нанёс урон какому-либо вражескому оператору за это действие, он восстанавливает 1 потерянный wound."
      },
      {
        "id": "wicked_blades",
        "name": "Wicked Blades",
        "uses": null,
        "usesLabel": "Пассив",
        "desc": "Разрушительные Силы не признают ничего так сильно, как смертоносную арену ближнего боя, и потому Blooded стремятся вонзить своё коварно острое оружие в плоть врагов.\n\nПрибавь 1 к обоим значениям Dmg оружия bayonet, bayonet & shield и improvised blade каждого дружественного оператора BLOODED на всю битву."
      }
    ]
  },
  "killTeams": {
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/5",
              "wr": "Piercing 1, Piercing Crits 2"
            },
            {
            ...
            },
            {
              ...
              "hit": "4+",
              "dmg": "4/5",
              "wr": "Severe, Shock, Stun"
            }
          ],
          "abilities": [
            {
              "name": "Obelisk Node Control",
              "text": "Каждый раз, когда этот оператор должен выполнить mission-действие (кроме Retrieve, Approved Ops 2025), если оно требует, чтобы этот оператор контролировал объектный маркер, вместо этого можно определить контроль по одному из твоих маркеров OBELISK NODE (см. faction rule Obelisk Node Matrix). Каждый раз, когда этот оператор должен выполнить действие Operate Hatch, вместо этого можно открыть или закрыть hatchway, точка доступа которого в пределах 1\" от одного из твоих маркеров OBELISK NODE. Учти, что условия действия Operate Hatch всё равно должны выполняться."
            },
            {
              "name": "Geomantic Disturbance",
              "text": "Выбери точку на terrain feature; эта точка должна быть видима и в пределах 8\" от этого оператора. Отдельно брось 2D6 за каждого оператора в пределах 2\" от этой точки. Если результат выше оставшихся wounds того оператора, нанеси ему урон, равный разнице.\n\nЭтот оператор не может выполнять это действие с приказом Conceal, или находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            },
            {
              "name": "Canoptek Control",
              "text": "SUPPORT. Выбери одного дружественного оператора CANOPTEK CIRCLE CANOPTEK, видимого и в пределах 6\" от этого оператора. Либо можно выбрать одного дружественного оператора CANOPTEK CIRCLE CANOPTEK, видимого этому оператору и находящегося в пределах твоей OBELISK NODE MATRIX (SUPPORT не применяется к этому выбору). Выбранный оператор может немедленно бесплатно выполнить действие за 1AP; он не может во время этого действия переместиться больше чем на 2\", либо быть убран и заново установлен на расстояние больше 2\".\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора, или во время counteraction.",
              "cost": "1AP"
            },
            {
              "name": "Molecular Breach",
              "text": "SUPPORT. Выбери одного дружественного оператора CANOPTEK CIRCLE, видимого и в пределах 6\" от этого оператора. Либо можно выбрать одного дружественного оператора CANOPTEK CIRCLE, видимого этому оператору и находящегося в пределах твоей OBELISK NODE MATRIX (SUPPORT не применяется к этому выбору). В следующий раз, когда выбранный оператор выполняет действие, в котором он перемещается, не перемещай его. Вместо этого убери его из killzone и установи заново на расстоянии, равном его характеристике Move (или 3\", если это был Dash), по горизонтали от исходного местоположения; в killzone с правилами close quarters эту дистанцию можно измерять через Wall terrain и над ним, и оператора можно установить по другую сторону. Учти, что при выполнении действия Charge он не получает дополнительной дистанции. Он должен быть установлен там, где это возможно, и, если это не действие Charge, не может быть установлен в пределах control range вражеского оператора.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/canoptek-circle/geomancer.png"
        },
        {
          ...
          "weapons": [
            ...
            },
            {
              ...
              "hit": "4+",
              "dmg": "4/5",
              "wr": "Piercing 1, Severe, Torrent 1\""
            },
            {
              "name": "Claws",
              "atk": 4,
          ...
          "abilities": [
            {
              "name": "Weapon Choice",
              "text": "В официальных правилах для каждой из 2 копий этого оператора отдельно выбирается вариант вооружения — Twin gauss reapers или Transdimensional isolator (плюс claws в любом случае) — при сборке ростера. Только 1 из 2 копий этого оператора в ростере может использовать Transdimensional isolator; вторая копия обязана использовать Twin gauss reapers. В этом приложении представлены оба варианта; используй только выбранный для каждой копии."
            },
            {
              "name": "Dimensional Banishment",
              "text": "*Dimensional Banishment: После того как этот оператор использует это оружие, если ты нанёс урон, но сохранил хотя бы один critical success, и цель не была выведена из строя, брось 2D6: если результат выше оставшихся wounds цели, цель выводится из строя (это имеет приоритет над правилами, которые предотвращают incapacitation, например, Medic!, FELLGOR RAVAGER Frenzy), и твой оппонент не может разместить маркер Reanimation (HIEROTEK CIRCLE) для этого оператора, если это применимо."
            },
            {
              "name": "Weapon Sentinel",
              "text": "Каждый раз, когда твой оппонент выбирает допустимую цель, если у этого оператора приказ Conceal, он не может иметь Light terrain для cover. Хотя это может позволить выбрать этого оператора целью (при условии, что он виден), это не убирает его cover save (если есть)."
            },
            {
              "name": "Steadfast",
              "text": "Каждый раз, когда определяется контроль над маркером, можно считать APL stat этого оператора равным 3. Если так, это имеет приоритет над всеми остальными правилами, то есть любые изменения его APL stat в этом случае игнорируются."
            }
          ],
          "portrait": "img/portraits/canoptek-circle/canoptek_tomb_crawler.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Overcharge",
              "text": "Выбери другого дружественного оператора CANOPTEK CIRCLE CANOPTEK, видимого и в пределах 3\" от этого оператора. Либо, если этот оператор находится в пределах твоей OBELISK NODE MATRIX, можно выбрать другого дружественного оператора CANOPTEK CIRCLE CANOPTEK в пределах твоей OBELISK NODE MATRIX. До конца следующей активации выбранного оператора прибавь 1 к его APL stat.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            },
            {
              "name": "Cranial Overload",
              "text": "Выбери одного вражеского оператора, видимого и в пределах 3\" от этого оператора. Либо, если этот оператор находится в пределах твоей OBELISK NODE MATRIX, можно выбрать одного вражеского оператора в пределах твоей OBELISK NODE MATRIX. До конца следующей активации того вражеского оператора вычти 1 из его APL stat.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/canoptek-circle/canoptek_macrocyte_accelerator.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Reanimate",
              "text": "Once per turning point, когда другой дружественный оператор CANOPTEK CIRCLE должен быть выведен из строя, если тот оператор виден и в пределах 6\" от этого оператора, или если этот и тот оператор находятся в пределах твоей OBELISK NODE MATRIX, можно использовать это правило при условии, что ни этот, ни тот оператор не в пределах control range вражеского оператора. Если используешь: тот дружественный оператор не выводится из строя, у него остаётся 1 wound, и до конца этого действия его нельзя вывести из строя; после этого действия он может немедленно выполнить бесплатное действие Dash, но должен закончить это движение в пределах control range этого оператора или в пределах твоей OBELISK NODE MATRIX. Вычти 1 из APL stat этого и того оператора до конца их следующих активаций соответственно, и если это правило было использовано во время активации того дружественного оператора, та активация заканчивается. Нельзя использовать это правило, если этот оператор выведен из строя, или если это действие Shoot и этот оператор был бы его primary или secondary целью."
            },
            {
              "name": "Nanoscarab Beam",
              "text": "Выбери одного дружественного оператора CANOPTEK CIRCLE, видимого и в пределах 6\" от этого оператора. Либо, если этот оператор находится в пределах твоей OBELISK NODE MATRIX, можно выбрать одного дружественного оператора CANOPTEK CIRCLE в пределах твоей OBELISK NODE MATRIX. Выбранный оператор восстанавливает до 3D3 потерянных wounds. Нельзя выбрать оператора, на котором в этом turning point уже было использовано правило Reanimate.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора, или более одного раза за turning point.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/canoptek-circle/canoptek_macrocyte_reanimator.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Weapon Choice",
              "text": "В официальных правилах для этого оператора отдельно для каждой из 3 копий выбирается вариант вооружения — Gauss scalpel или Tesla caster (плюс claws & tail в любом случае) — при сборке ростера. В этом приложении представлены оба варианта; используй только выбранный для каждой копии."
            },
            {
              "name": "Aggressive Defence",
              "text": "Если этот оператор выводится из строя вражеским оператором в пределах 2\" от него, перед тем как этот оператор убирается из killzone, брось один D3: при результате 2+ нанеси 1 урон тому вражескому оператору."
            },
            {
              "name": "Expendable Construct",
              "text": "Этот оператор игнорируется для kill/elimination op твоего оппонента (когда он выведен из строя), а также при определении твоего стартового количества операторов. Он также игнорируется для victory conditions и начисления VP, если они требуют, чтобы операторы escape, survive или были incapacitated вражескими операторами (если он escape/survive/incapacitated, это учитывается при определении того, сколько операторов должно escape/survive/be incapacitated, и т.п.)."
            },
            {
              "name": "A Ceaseless Scuttling",
              "text": "As a STRATEGIC GAMBIT в каждом turning point после первого, если у тебя меньше трёх не выведенных из строя дружественных операторов CANOPTEK CIRCLE WARRIOR, можно установить ещё одного, готового и с приказом Conceal, в пределах своей drop zone (варианты его вооружения можно выбрать как обычно)."
            }
          ],
          "portrait": "img/portraits/canoptek-circle/canoptek_macrocyte_warrior.png"
        }
      ],
      "poolPick": 0,
      "pool": [],
      "equipment": "Canoptek Circle",
      "lore": {
        "intro": "Kill team CANOPTEK CIRCLE состоит из зловещих чужеродных конструктов, подчинённых своему Cryptek-хозяину. Бесчувственные и неживые Canoptek-конструкты преодолевают любые препятствия на пути амбиций Cryptek — будь то камень и металл или тела живых, — пока их хозяин получает доступ к узлам силы и данных, чтобы ещё больше подпитать древние способности конструктов.",
        "operatives": [
          {
            "name": "Geomancer",
            "text": "Обладая эонами криптогеометрических знаний и эзотерических технологий, Geomancer'ы — это Cryptek'и, манипулирующие физической материей смертоносным образом. Они направляют пульсирующую энергию через свои tremorglaive, чтобы сокрушать вражеские укрепления, разрывать запечатанные hatch или сотрясать врагов на атомарном уровне. С помощью устройств, известных как geomantic manipulators, эти древние учёные также способны трансмутировать материю в obelisk nodes и через эти локусы получать доступ к скрытым резервам силы и информации."
          },
          {
            "name": "Canoptek Tomb Crawler",
            "text": "Tomb Crawler — это громадные Canoptek-конструкты, обладающие огромной силой, способные как сдвигать тонны обломков, так и сминать бронированных захватчиков. Затаившись в укромных нишах на срок от дней до тысячелетий, они могут внезапно активироваться, чтобы устроить засаду на врага с помощью совершенного оружия, установленного на их закалённых панцирях."
          },
          {
            "name": "Canoptek Macrocyte Warrior",
            "text": "Macrocyte Warrior используют шарнирные когти и антигравитационные технологии, чтобы перемещаться сквозь плотную, тесную местность стремительными рывками. По сути расходный материал, они тем не менее чрезвычайно смертоносны, атакуя ударами клинков из живого металла и вспышками энергии."
          },
          {
            "name": "Canoptek Macrocyte Accelerator",
            "text": "Оснащённые акселераторной мандибулой, эти модифицированные конструкты поддерживают других Canoptek-конструктов своего Cryptek'а и обеспечивают их работу на пределе эффективности. Они черпают энергетические резервы, разбросанные по гробнице, — либо передавая внезапный импульс фазовой энергии или данных другим конструктам, либо используя его как опасный разряд, поджаривающий чужие нейронные цепи."
          },
          {
            "name": "Canoptek Macrocyte Reanimator",
            "text": "Macrocyte Reanimator оснащены компактным nanoscarab-проектором. Испускаемый им луч несёт волну из триллионов микроскопических конструктов, способных восстанавливать повреждённые Necron-технологии — будь то проход в гробнице или живой металл её обитателей. Они бездумно поступают так же и с живой плотью, ужасающе воссоздавая её атом за атомом."
          }
        ]
      },
      "factionRules": [
        {
          "name": "Obelisk Node Matrix",
          "text": "Obelisk nodes — это концентрации Necron-технологии, узлы энергетических и информационных потоков. Извлечённые из мест древних захоронений, сформированные из перестроенной местной материи или перенесённые из карманного измерения, эти угловатые узлы способны наделять силой Cryptek и его слуг: соединяясь в единую матрицу, они помогают амбициям Cryptek, одновременно мешая его врагам.\n\nAs a STRATEGIC GAMBIT в первом turning point размести свои три маркера OBELISK NODE полностью в пределах своей территории. As a STRATEGIC GAMBIT в каждом turning point после первого можно передвинуть каждый из своих маркеров OBELISK NODE до 3\" по горизонтали.\n\nТвои маркеры OBELISK NODE контролируют другие маркеры в пределах 1\" от них, которые не оспаривает ни один вражеский оператор (для этой цели твои маркеры OBELISK NODE считаются дружественными операторами). Если маркеры OBELISK NODE больше чем одного игрока претендовали бы на контроль одного и того же маркера, ни один из них не контролирует его.\n\nКаждый раз, когда один из твоих маркеров OBELISK NODE находится в пределах 6\" по горизонтали от другого твоего маркера OBELISK NODE, эти маркеры и область между ними образуют OBELISK NODE MATRIX сверху и снизу (то есть их высота в killzone не имеет значения). Если этому условию удовлетворяют все три твоих маркера OBELISK NODE, образуется более крупная объединённая OBELISK NODE MATRIX.\n\nКаждый раз, когда дружественный оператор CANOPTEK CIRCLE находится в пределах твоей OBELISK NODE MATRIX:\n- Оружие на его datacard получает weapon rule Accurate 1.\n- Прибавь 1 к его APL stat (максимум до 3)."
        },
        {
          "name": "Hypershielding",
          "text": "Квантовая энергия излучается из матрицы, срабатывая по защитным протоколам. Дымка поглощает твёрдые попадания вспышками зеленовато-белого света и преломляет энергетические удары, а её колышущаяся пелена сбивает с толку целящихся.\n\nКаждый раз, когда оператор стреляет по дружественному оператору CANOPTEK CIRCLE, если твоя OBELISK NODE MATRIX intervening, или тот дружественный оператор находится в пределах твоей OBELISK NODE MATRIX, можно перебросить любые свои defence dice с одним и тем же результатом (например, результаты 2).",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Transdynamic Amplification",
          "text": "Изгибаясь в загадочные линзы, сжимающие осколки реальности, мерцающая матрица усиливает мощь пугающих энергетических технологий Necron.\n\nКаждый раз, когда дружественный оператор CANOPTEK CIRCLE стреляет, если твоя OBELISK NODE MATRIX intervening, или цель находится в пределах твоей OBELISK NODE MATRIX, оружие того дружественного оператора получает weapon rule Ceaseless.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Cryptogravitic Repulsion",
          "text": "Фундаментальные силы вселенной давно освоены Necron. Когда враги наступают, глухие волны и извивающиеся вихри гравитации среди obelisk nodes отталкивают потенциальных нарушителей.\n\nOnce per action, в первый раз, когда вражеский оператор должен переместиться в пределы твоей OBELISK NODE MATRIX, эта дистанция считается на 1\" больше. Учти: если у того вражеского оператора не хватает дистанции движения (например, он уже в конце своего движения), тот оператор не может переместиться в пределы твоей OBELISK NODE MATRIX.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Souldrain",
          "text": "Безжизненный холод проникает в сердца тех, кто осмелился вторгнуться в владения Necron, — истощающая утечка сил и жизненной энергии, делающая их лёгкой добычей.\n\nКаждый раз, когда вражеский оператор находится в пределах твоей OBELISK NODE MATRIX, либо когда он сражается или отвечает (retaliating) против дружественного оператора CANOPTEK CIRCLE, находящегося в пределах твоей OBELISK NODE MATRIX, вычти 1 из обоих Dmg stats оружия ближнего боя того вражеского оператора (минимум до 2) до конца этой активации/counteraction. Учти: если вражеский оператор проходит через твою OBELISK NODE MATRIX, это изменение применяется в конце того действия движения до конца активации/counteraction.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Shield Flare",
          "text": "Вспышка — и пули снайперов поглощаются микроизмерениями; клинки проходят сквозь внезапно сфазированную материю; осколки времени стираются и переписываются, удар так и не достигает цели. Энергии матрицы отказывают врагам Necron даже в самой малой победе над теми, кто выше их.\n\nИспользуй этот firefight ploy, когда attack die наносит Normal Dmg дружественному оператору CANOPTEK CIRCLE. Если твоя OBELISK NODE MATRIX intervening, или тот дружественный оператор находится в пределах твоей OBELISK NODE MATRIX, проигнорируй этот нанесённый урон. Учти, что intervening определяет твой оппонент (то есть откуда на базе его оператора проводить линии прицеливания).",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Animate Obelisk Nodes",
          "text": "Повинуясь некой скрытой команде, нависающие obelisk nodes перемещаются в новые позиции космического соединения.\n\nИспользуй этот firefight ploy, когда наступает твоя очередь активироваться или выполнить counteraction дружественным оператором. Вместо этого передвинь любое количество своих маркеров OBELISK NODE. Они могут переместиться суммарно до 6\" по горизонтали, а дистанции всегда округляются до целого дюйма вверх (например, если маркер двигается на 1.5\", это считается движением на 2\"). Например, можно передвинуть один маркер на 6\", три маркера по 1\" каждый, либо любую комбинацию, не превышающую 6\" в сумме. Можно также передвинуть их на 0\" (чтобы фактически пропустить активацию). В любом случае после этого твой оппонент активируется как обычно.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Nodal Response",
          "text": "Потусторонние импульсы искусственной мысли пронизывают obelisk nodes, подстраивая потоки энергии и данных под стремительно меняющуюся обстановку.\n\nИспользуй этот firefight ploy во время активации дружественного оператора CANOPTEK CIRCLE, до или после того, как он выполняет действие. Можно либо сменить один из strategy ploys, использованных в этом turning point (дополнительный CP платится только если тот ploy стоит дороже), либо использовать strategy ploy прямо сейчас (заплатив его CP-стоимость как обычно).",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Sacrificial Thrall",
          "text": "Canoptek-конструкты запрограммированы любой ценой защищать своего хозяина.\n\nИспользуй этот firefight ploy, когда дружественный оператор CANOPTEK CIRCLE GEOMANCER выбран допустимой целью действия Shoot, либо противником в действии Fight. Выбери другого дружественного оператора CANOPTEK CIRCLE CANOPTEK, видимого и в пределах 3\" от того первого дружественного оператора, чтобы вместо него он стал допустимой целью (или тем, с кем сражаются), даже если обычно он для этого не подходил бы. Если это действие Fight, для целей этого действия считай, что тот другой оператор находится в пределах control range сражающегося оператора на всё время этого действия. Если это действие Shoot, тот другой оператор считается in cover или obscured только если исходная цель была in cover или obscured.\n\nЭтот ploy не действует, если это действие Shoot и дальнобойное оружие имеет weapon rule Blast или Torrent.",
          "cost": "Firefight Ploy"
        }
      ],
      "statusTokens": [
        {
          ...
          "name": "Matrix Manipulator",
          "target": "friendly",
          "text": "Один из вариантов faction equipment этой команды — Matrix Manipulator. * Matrix Manipulator: Once per battle, во время активации или counteraction дружественного оператора CANOPTEK CIRCLE ты можешь использовать это правило. Если используешь, до конца той активации/counteraction дружественный оператор CANOPTEK CIRCLE GEOMANCER считается твоим четвёртым маркером OBELISK NODE — отметь его этим токеном, пока действует этот эффект."
        },
        {
          "id": "phase_shifter",
          "name": "Phase Shifter",
          "target": "friendly",
          "text": "Один из вариантов faction equipment этой команды — Phase Shifter. * Phase Shifter: Once per turning point, когда оператор стреляет по дружественному оператору CANOPTEK CIRCLE GEOMANCER, в начале этапа Roll Defence Dice, можно использовать это правило. Если используешь, ухудши x weapon rule Piercing на 1 (если есть) до конца этой последовательности (Piercing 1 в этом случае игнорируется). Отметь того GEOMANCER этим токеном — Phase Shifter уже был использован на нём в этом turning point, и его нельзя использовать снова до следующего turning point."
        },
        {
          "id": "reanimate",
          "name": "Reanimate",
          "target": "friendly",
          "text": "Некоторые операторы этой команды обладают правилом Reanimate. * Reanimate: Once per turning point, когда другой дружественный оператор CANOPTEK CIRCLE должен быть выведен из строя, если он виден и в пределах 6\" от оператора с этим правилом, или если оба оператора находятся в пределах твоей OBELISK NODE MATRIX, можно использовать это правило при условии, что ни один из них не в пределах control range вражеского оператора. Если используешь: тот дружественный оператор не выводится из строя, у него остаётся 1 wound, и до конца этого действия его нельзя вывести из строя; после этого действия он может немедленно выполнить бесплатное действие Dash, но должен закончить это движение в пределах control range оператора с этим правилом или в пределах твоей OBELISK NODE MATRIX. Отметь того дружественного оператора этим токеном — правило Reanimate нельзя использовать снова на нём в этом turning point."
        }
      ]
    },
    "Ratlings": {
      ...
      "required": [
        {
          ...
          "abilities": [
            {
              "name": "Weapon Choice",
              "text": "В официальных правилах для этого оператора выбирается вариант вооружения — Battle rifle или Sniper rifle (плюс fists в любом случае) — при сборке ростера. В этом приложении представлены оба варианта; используй только выбранный."
            },
            {
              "name": "Munitorum Contacts",
              "text": "Можно выбрать один дополнительный вариант снаряжения (equipment option)."
            },
            {
              "name": "Target Designation",
              "text": "STRATEGIC GAMBIT. Выбери одного видимого этому оператору вражеского оператора. До конца turning point каждый раз, когда дружественный оператор RATLING стреляет по этому вражескому оператору из rifle, то оружие получает weapon rule Lethal 5+."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_fixer.png"
        }
      ],
      "poolPick": 10,
      "pool": [
        {
          ...
          "abilities": [
            {
              "name": "Beast",
              "text": "Этот оператор не может выполнять никакие действия, кроме Charge, Dash, Fall Back, Fight и Reposition. Он не может использовать оружие, которого нет на его datacard."
            },
            {
              "name": "Early Warning",
              "text": "Один раз за turning point, после того как вражеский оператор выполняет действие, в котором он передвигается или устанавливается (is set up), ты можешь прервать ту активацию/контрдействие, чтобы использовать это правило. Если делаешь это: каждый дружественный оператор RATLING (кроме OGRYN и BULLGRYN) в пределах 6\" от этого оператора и в пределах 2\" от того вражеского оператора может немедленно выполнить бесплатное действие Dash или Fall Back в выбранном тобой порядке (выбирается отдельно для каждого), но не может переместиться больше чем на 3\" во время этого действия. В любом случае, каждый из них не может закончить это перемещение в пределах 2\" от вражеского оператора, если он не невидим для всех вражеских операторов, когда заканчивает это перемещение (если это невозможно для оператора, он не может двигаться)."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_battlemutt.png"
        },
        {
          "name": "Bullgryn",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Weapon Choice",
              "text": "В официальных правилах для этого оператора выбирается по одному варианту из каждой пары — Grenadier gauntlet или Power maul, и Brute shield или Slabshield — при сборке ростера. В этом приложении представлены все варианты; используй только выбранную комбинацию."
            },
            {
              "name": "Shield",
              "text": "Если у этого оператора slabshield, у него Save stat 3+; если у него brute shield, то каждый раз, когда он дерётся или отвечает (retaliating), каждый твой block можно использовать, чтобы заблокировать два неразрешённых успеха (unresolved successes) вместо одного."
            },
            {
              "name": "Brute",
              "text": "Каждый раз, когда твой оппонент выбирает допустимую цель, если у этого оператора приказ Conceal, он не может использовать Light terrain для укрытия (cover). Хотя это может позволить выбрать этого оператора целью (если он виден), это не убирает его cover save (если есть)."
            },
            {
              "name": "Slow-witted",
              "text": "Этому оператору нужно потратить 1 дополнительный AP, чтобы выполнить действие Pick Up Marker и mission-действия (кроме Operate Hatch)."
            },
            {
              "name": "Selection Limit",
              "text": "Bullgryn и Ogryn вместе — не больше 3 в ростере. За каждый из этих 3 незанятых слотов один раз за битву можно сделать выбранный ratling ploy бесплатным (0CP), вместо выбора Bullgryn/Ogryn. UI не проверяет это автоматически — считайте вручную."
            }
          ],
          "portrait": "img/portraits/ratlings/bullgryn.png"
        },
        {
          "name": "Ogryn",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Bayonet Charge",
              "text": "Каждый раз, когда этот оператор заканчивает движение во время действия Charge, ты можешь нанести D3+1 урона одному вражескому оператору в пределах его control range."
            },
            {
              "name": "Brute",
              "text": "Каждый раз, когда твой оппонент выбирает допустимую цель, если у этого оператора приказ Conceal, он не может использовать Light terrain для укрытия (cover). Хотя это может позволить выбрать этого оператора целью (если он виден), это не убирает его cover save (если есть)."
          ...
          "portrait": "img/portraits/ratlings/ogryn.png"
        },
        {
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/4",
              "wr": "Devastating 1, Heavy (Dash only), Piercing 1"
            },
            {
              ...
              "hit": "2+",
              "dmg": "4/2",
              "wr": "Devastating 4, Heavy, Piercing 1, Severe"
            },
            {
              "name": "Fists",
              "atk": 3,
          ...
          "abilities": [],
          "portrait": "img/portraits/ratlings/ratling_big_shot.png"
        },
        {
          "name": "Ratling Bomber",
          "apl": 2,
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/5",
              "wr": "Range 3\", Blast 1\", Heavy (Reposition only), Limited 1, Piercing 1, Saturate"
            },
            {
              "name": "Sniper rifle (mobile)",
              "atk": 4,
          ...
          "abilities": [
            {
              "name": "Tripwire",
              "text": "Когда устанавливаешь снаряжение перед битвой, можно разместить до двух своих маркеров Tripwire полностью в пределах своей территории и более чем в 2\" от других маркеров, access points и Accessible terrain. В первый раз, когда этот маркер оказывается в пределах control range вражеского оператора, убери этот маркер, вычти 1 из APL stat того оператора до конца его следующей активации и заверши его действие (если есть), даже если эффекты того действия не выполнены полностью. Если маркер невозможно разместить, передвинь его на минимальное необходимое расстояние."
            },
            {
              "name": "Mine",
              "text": "Мины, выбранные из universal equipment, наносят 2D3+3 урона вместо обычного, а дружественные операторы RATLING (кроме OGRYN и BULLGRYN) игнорируются для эффектов твоих мин (т.е. они не могут сработать от них или получить от них урон). Это имеет приоритет над обычными правилами мин."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_bomber.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Hunter",
              "text": "Этот оператор может выполнить действие Charge, имея приказ Conceal. Если он делает это во время своей активации, до конца той активации прибавь 1 к Atk stat его combat knife, и то melee-оружие получает weapon rule Brutal."
            },
            {
              "name": "Lie in Wait",
              "text": "Каждый раз, когда этот оператор отвечает (retaliating), находясь в пределах control range Light или Heavy terrain, разрешай первый attack dice ты (т.е. вместо атакующего — защищающийся)."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_hardbit.png"
        },
        {
          "name": "Ratling Raider",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Slingshot",
              "text": "Выбери точку на terrain feature; та точка должна быть видима и в пределах 6\" от этого оператора. Убери этого оператора из killzone и установи его заново в месте, которое можно разместить полностью в пределах 6\" по горизонтали от той точки, не в пределах control range вражеских операторов, и с видимостью на ту точку.\n\nЭто действие считается действием Reposition. Этот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора, или во время активации, в которой он выполнил действие Charge, Fall Back или Shoot (или наоборот).",
              "cost": "1AP"
            },
            {
              "name": "Grappling Hook",
              "text": "Каждый раз, когда этот оператор взбирается вверх (climbing up), можно считать вертикальную дистанцию как 2\" (независимо от того, на какую высоту оператор реально перемещается)."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_raider.png"
        },
        {
          "name": "Ratling Sneak",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Optics",
              "text": "До начала следующей активации этого оператора, каждый раз, когда он стреляет, вражеские операторы не могут быть obscured, а стационарный профиль suppressed sniper rifle этого оператора получает weapon rule Lethal 5+.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            },
            {
              "name": "Evade",
              "text": "Один раз за turning point, после того как вражеский оператор выполняет действие, ты можешь прервать ту активацию/контрдействие и выполнить бесплатное действие Dash этим оператором. Учти, что этот оператор не может использовать faction rule Scarper (у него вместо этого есть это правило)."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_sneak.png"
        },
        {
          "name": "Ratling Sniper",
          "apl": 2,
          ...
          "abilities": [],
          "portrait": "img/portraits/ratlings/ratling_sniper.png",
          "maxCopies": 10
        },
        {
          ...
          "abilities": [
            {
              "name": "Spot",
              "text": "SUPPORT. Выбери одного вражеского оператора, видимого этому оператору. До конца turning point, каждый раз, когда дружественный оператор RATLING в пределах 3\" от этого оператора стреляет по тому вражескому оператору, можно использовать этот эффект. Если делаешь это:\n• Дальнобойное оружие (ranged weapons) того дружественного оператора получает weapon rule Seek Light.\n• Тот вражеский оператор не может быть obscured.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_spotter.png"
        },
        {
          ...
          "abilities": [
            ...
            {
              "name": "Well Stocked",
              "text": "Если ты выбираешь Ammo Cache из universal equipment, можно установить дополнительный маркер Ammo Cache."
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_stashmaster.png"
        },
        {
          ...
          "abilities": [
            {
              ...
              "text": "SUPPORT. Выбери другого дружественного оператора RATLING, видимого этому оператору и находящегося в пределах 6\" от него. До конца его следующей активации прибавь 1 к его APL stat.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/ratlings/ratling_vox_thief.png"
        }
      ],
      "equipment": "Ratlings",
      "lore": {
        "intro": "Kill team Ratlings — маленький, но опасный отряд разведчиков-стрелков Astra Militarum, набранный из низкорослого субвида homo sapiens, прославившегося меткостью и умением оставаться незамеченным. Что Ratlings недобирают в росте и физической силе, они с лихвой компенсируют скрытностью, хладнокровием под огнём и почти сверхъестественной способностью попадать в цель с любой дистанции — не забывая при этом прихватить с собой всё, что плохо лежит.",
        "operatives": [
          {
            "name": "Ratling Fixer",
            "text": "Командир отряда и мастер добывать снаряжение — там, где не хватает уставного пайка, Fixer всегда найдёт лишний ствол."
          },
          {
            "name": "Ratling Battlemutt",
            "text": "Верный четвероногий компаньон, чутьё которого предупреждает отряд об опасности за секунды до того, как она успевает подобраться близко."
          },
          {
            "name": "Bullgryn",
            "text": "Закованный в самодельную броню гигант, прикрывающий щитом хрупких сородичей и врезающийся в ряды противника там, где меткость уже бессильна."
          },
          {
            "name": "Ogryn",
            "text": "Наёмный силач, чья грубая мощь и штыковой натиск компенсируют миниатюрным Ratlings нехватку мускулов."
          },
          {
            "name": "Ratling Big Shot",
            "text": "Стрелок с tankstopper rifle, способным пробить броню там, где обычная пуля бессильна."
          },
          {
            "name": "Ratling Bomber",
            "text": "Подрывник отряда, минирующий подступы и обрушивающий на врага взрывной арсенал из укрытия."
          },
          {
            "name": "Ratling Hardbit",
            "text": "Ветеран рукопашных стычек, терпеливо выжидающий в засаде с ножом наготове."
          },
          {
            "name": "Ratling Raider",
            "text": "Лёгкий разведчик с крюком-кошкой, способный оказаться в тылу врага там, где никто не ждёт."
          },
          {
            "name": "Ratling Sneak",
            "text": "Мастер маскировки, чья оптика превращает любую цель в лёгкую добычу."
          },
          {
            "name": "Ratling Sniper",
            "text": "Стрелок-снайпер, чьё имя говорит само за себя — точный выстрел с любой дистанции."
          },
          {
            "name": "Ratling Spotter",
            "text": "Корректировщик огня, подсвечивающий цель для товарищей и лишающий её любого укрытия."
          },
          {
            "name": "Ratling Stashmaster",
            "text": "Отрядный завхоз, ловкие руки которого не упустят ни единого трофея на поле боя."
          },
          {
            "name": "Ratling Vox-Thief",
            "text": "Связист-ловкач, ворующий вражеские частоты, чтобы ускорить реакцию своих товарищей."
          }
        ]
      },
      "factionRules": [
        {
          "name": "Scarper",
          "text": "Несмотря на свой малый рост, Ratlings отличаются быстротой ног, используя скорость и ловкость, чтобы опережать и уклоняться от противника.\n\nПосле каждой активации вражеского оператора, до того как активируется следующий оператор, один дружественный оператор RATLING (кроме BULLGRYN, OGRYN и SNEAK) может выполнить бесплатное действие Dash, но не может закончить это перемещение в пределах 3\" от вражеского оператора, если он не невидим для всех вражеских операторов, когда заканчивает это перемещение.\n\nКаждый дружественный оператор может делать это не более одного раза за turning point и не может делать это после финальной активации turning point."
        },
        {
          "name": "Sniper Positions",
          "text": "Каждый раз, когда дружественный оператор RATLING находится более чем в 6\" от вражеских операторов и в пределах 1\" от Heavy terrain, стационарный профиль его rifle (если есть) получает weapon rule Silent.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Crack Shots",
          "text": "Каждый раз, когда дружественный оператор RATLING стреляет по вражескому оператору более чем в 6\" от себя, если тот дружественный оператор не выполнял действие Charge, Fall Back или Reposition во время этой активации, либо если это контрдействие (counteraction), его rifle (если есть) получает weapon rule Balanced. Учти, что этому оператору не запрещено выполнять те действия после Shoot.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Shifty",
          "text": "Каждый раз, когда дружественный оператор RATLING (кроме OGRYN или BULLGRYN) имеет приказ Conceal и находится в cover, его нельзя выбрать допустимой целью — это имеет приоритет над всеми остальными правилами (например, Seek, Vantage terrain), кроме случаев, когда вражеский оператор находится в пределах 2\".",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Frontline Assault",
          "text": "Каждый раз, когда дружественный оператор RATLING BULLGRYN или дружественный оператор RATLING OGRYN, находящийся на территории оппонента или в пределах 3\" от объектного маркера, стреляет, дерётся или отвечает (retaliating), его оружие получает weapon rule Balanced.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Survival Instincts",
          "text": "Используй этот firefight ploy, когда вражеский оператор стреляет или дерётся против дружественного оператора RATLING (кроме OGRYN или BULLGRYN) и ты выделяешь кубик для блока (allocating a dice to block). Если это обычный успех, можно заблокировать один неразрешённый critical success; если это critical success, можно заблокировать два неразрешённых успеха (обычных или критических).",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Sharpshot",
          "text": "Используй этот firefight ploy, когда дружественный оператор RATLING выполняет действие Shoot с rifle и ты выбираешь допустимую цель. Наличие других дружественных операторов RATLING в пределах control range вражеского оператора не мешает выбрать того вражеского оператора целью.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Larcenous",
          "text": "Используй этот firefight ploy во время активации дружественного оператора RATLING (кроме OGRYN или BULLGRYN). До конца той активации тому оператору не нужно контролировать маркер, чтобы выполнить действие Pick Up Marker или mission-действия, которые обычно этого требуют (это имеет приоритет над условиями того действия — достаточно оспаривать маркер), и наличие вражеского оператора в его control range не мешает это делать.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Shoot and Hide",
          "text": "Используй этот firefight ploy после того, как дружественный оператор RATLING с приказом Engage выполнил действие Shoot с rifle. Если он находится более чем в 3\" от вражеских операторов, либо не виден ни одному вражескому оператору, можно сменить его приказ на Conceal.",
          "cost": "Firefight Ploy"
        }
      ],
      "statusTokens": [
        {
          ...
          "name": "Target Designation",
          "target": "enemy",
          "text": "Отмечает вражеского оператора, выбранного через Strategic Gambit RATLING FIXER Target Designation. До конца turning point, каждый раз, когда дружественный оператор RATLING стреляет по этому оператору из rifle, то оружие получает weapon rule Lethal 5+."
        },
        {
          "id": "spot",
          "name": "Spot",
          "target": "enemy",
          "text": "Отмечает вражеского оператора, выбранного действием Spot оператора RATLING SPOTTER. До конца turning point, каждый раз, когда дружественный оператор RATLING в пределах 3\" от того SPOTTER стреляет по этому оператору, можно применить эффект: дальнобойное оружие того дружественного оператора получает weapon rule Seek Light, а этот оператор не может быть obscured."
        },
        {
          "id": "optics",
          "name": "Optics",
          "target": "friendly",
          "text": "Отмечает оператора RATLING SNEAK, использовавшего действие Optics. До начала его следующей активации, каждый раз, когда он стреляет, вражеские операторы не могут быть obscured, а стационарный профиль его suppressed sniper rifle получает weapon rule Lethal 5+."
        },
        {
          "id": "early_warning",
          "name": "Early Warning",
          "target": "friendly",
          "text": "Отмечает, что оператор RATLING BATTLEMUTT уже использовал faction-правило Early Warning в этом turning point (можно использовать только один раз за turning point)."
        },
        {
          "id": "evade",
          "name": "Evade",
          "target": "friendly",
          "text": "Отмечает, что оператор RATLING SNEAK уже использовал своё правило Evade в этом turning point (можно использовать только один раз за turning point)."
        },
        {
          "id": "scarper",
          "name": "Scarper",
          "target": "friendly",
          "text": "Отмечает, что этот дружественный оператор RATLING уже выполнил бесплатное действие Dash по faction rule Scarper в этом turning point (можно использовать только один раз за turning point на оператора)."
        }
      ]
    },
    "Elucidian Starstriders": {
      ...
      "equipment": "Elucidian Starstriders",
      "required": [
        {
          "name": "Elucia Vhane",
          "apl": 3,
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/5",
              "wr": "Range 8\", Piercing Crits 1, Seek Light"
            },
            {
          ...
          "abilities": [
            {
              "name": "Digital Lasers",
              "text": "Каждый раз, когда этот оператор выполняет действие Fight, в начале шага Attack Dice ты можешь использовать это правило. Если используешь — нанеси 1 урон вражескому оператору в этой последовательности."
            },
            {
              "name": "Disruption Field",
              "text": "Каждый раз, когда оператор стреляет по этому оператору, игнорируй weapon rule Piercing."
            },
            {
              "name": "Merciless",
              "text": "Каждый раз, когда этот оператор стреляет по, дерётся против или отвечает (retaliating) вражескому оператору, который уже был ранен на момент начала действия, оружие этого оператора получает weapon rule Balanced; если оружие уже имеет это weapon rule, вместо этого оно получает weapon rule Ceaseless."
            },
            {
              "name": "Reputation to Maintain",
              "text": "В первый раз за битву, когда этот оператор выводит из строя вражеского оператора, ты можешь либо получить 1 дополнительное CP, либо использовать дополнительное правило WARRANT OF TRADE — то есть до пяти применений за битву вместо базовых четырёх. Обрати внимание, что одно и то же правило WARRANT OF TRADE всё равно нельзя использовать более одного раза за битву."
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/elucia_vhane.png"
        },
        {
          "name": "Canid",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Beast",
              "text": "Этот оператор не может выполнять никакие действия, кроме Charge, Dash, Fall Back, Fight, Gather, Guard, Reposition, Pick Up Marker и Place Marker, которых нет на его datacard. Он не может использовать оружие, которого нет на его datacard."
            },
            {
              "name": "Loyal Companion",
              "text": "Каждый раз, когда вражеский оператор выполняет действие Fight, если этот оператор — допустимая цель для драки, ты можешь заставить его выбрать этого оператора для драки вместо другой цели. Каждый раз, когда вражеский оператор заканчивает действие Charge в пределах control range другого дружественного оператора ELUCIDIAN STARSTRIDER в пределах 3\" от этого оператора, если этот оператор не в пределах control range вражеских операторов, этот оператор может немедленно выполнить бесплатное действие Charge (для этого можно сменить его приказ на Engage), но должен закончить это движение в пределах control range того вражеского оператора."
            },
            {
              "name": "Gather",
              "text": "Выполни бесплатное действие Dash или Reposition этим оператором. Во время этого движения он может выполнить бесплатное действие Pick Up Marker или Place Marker (control range для этого можно определять уже во время того действия), а оставшуюся дистанцию движения от действия Dash или Reposition можно использовать после этого.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/canid.png"
        },
        {
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "1/1",
              "wr": "Range 6\", Lethal 5+, Silent, Stun"
            },
            {
              "name": "Power weapon",
              "atk": 5,
          ...
          "abilities": [
            ...
            {
              "name": "Bladed Stance",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating), ты можешь разрешить один из своих успехов перед обычным порядком. Если делаешь так, тот успех должен быть использован для блока."
            },
            {
              "name": "Zealot",
              "text": "Если этот оператор выведен из строя во время действия Fight, ты можешь нанести удар вражескому оператору в этой последовательности одним из своих неразрешённых успехов, прежде чем этот оператор будет убран из killzone."
            },
            {
              "name": "Trained Assassin",
              "text": "Смени приказ этого оператора. Этот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/death_cult_executioner.png"
        },
        {
          "name": "Lectro-Maester",
          "apl": 2,
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/4",
              "wr": "Range 8\", 1\" Devastating 1, Rending"
            },
            {
              "name": "Gun butt",
              "atk": 3,
          ...
          "abilities": [
            {
              ...
              "text": "Один раз за каждую свою активацию этот оператор может выполнить действие Pick Up Marker, Place Marker или mission action за 1 AP меньше."
            },
            {
              "name": "Voltaghiest Array",
              "text": "Каждый раз, когда оператор стреляет по дружественному оператору ELUCIDIAN STARSTRIDER в пределах 4\" от этого оператора, тот дружественный оператор может перебросить один из своих defence dice."
            },
            {
              "name": "Calibrate Voltagheist",
              "text": "Выбери один из следующих эффектов, который действует до начала следующей активации этого оператора, до его incapacitation или до повторного выполнения этого действия (что наступит раньше):\n• Charge: voltaic pistol этого оператора получает weapon rule Lethal 4+.\n• Field: каждый раз, когда вражеский оператор заканчивает действие Charge, Dash, Fall Back или Reposition, будучи видимым этому оператору и в пределах 4\" от него, нанеси D6 урона тому вражескому оператору.\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "0AP"
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/lectro-maester.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Medic!",
              "text": "В первый раз за каждый turning point, когда другой дружественный оператор ELUCIDIAN STARSTRIDER должен быть выведен из строя, будучи видимым этому оператору и в пределах 3\" от него, ты можешь использовать это правило, при условии что ни этот, ни тот другой оператор не в пределах control range вражеского оператора. Если используешь: тот дружественный оператор не выводится из строя, у него остаётся 3 wounds, и до конца этого действия его нельзя вывести из строя. После этого действия тот дружественный оператор может немедленно выполнить бесплатное действие Dash, но должен закончить это движение в пределах control range этого оператора. Если это правило было использовано во время активации того дружественного оператора, та активация заканчивается. Нельзя использовать это правило, если этот оператор выведен из строя, или если это действие Shoot, в котором этот оператор был бы primary или secondary целью."
            },
            {
              "name": "Normaliser Helm",
              "text": "Каждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER находится в пределах 6\" от этого оператора, можно игнорировать любые изменения его характеристик от ранений (включая характеристики его оружия)."
            },
            {
              "name": "Healing Serum",
              "text": "Выбери одного дружественного оператора ELUCIDIAN STARSTRIDER в пределах control range этого оператора, чтобы он восстановил до D3+3 потерянных wounds. Нельзя выбрать оператора, на котором в этом turning point уже было использовано правило Medic!. Этот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/rejuvenat_adept.png"
        },
        {
          "name": "Voidmaster",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Disciplinarian",
              "text": "SUPPORT. Каждый раз, когда другой дружественный оператор ELUCIDIAN STARSTRIDER NAVIS находится в пределах 3\" от этого оператора, оружие того оператора (кроме оружия PRIVATEER SUPPORT ASSET) получает weapon rule Balanced; если оружие уже имеет это weapon rule, вместо этого оно получает weapon rule Ceaseless."
            },
            {
              "name": "Hardy",
              "text": "Один раз за битву, когда attack dice наносит Normal Dmg этому оператору, можно проигнорировать этот нанесённый урон."
            },
            {
              "name": "Uncompromising Fire",
              "text": "Выполни два бесплатных действия Shoot этим оператором (это имеет приоритет над ограничениями действий). Нужно выбрать его relic laspistol для одного действия и artificer shotgun (close range) для другого (в любом порядке). Этот оператор не может выполнять это действие, имея приказ Conceal, находясь в пределах control range вражеского оператора, или во время активации, в которой он уже выполнил действие Shoot (и наоборот).",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/voidmaster.png"
        },
        {
          "name": "Voidsman",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Crewmen",
              "text": "Один раз за turning point, каждый раз, когда ты бы выполнял counteract, если в этом turning point ещё не был использован PRIVATEER SUPPORT ASSET, можно использовать это правило. Если используешь, можно выполнить counteract дружественным оператором ELUCIDIAN STARSTRIDER VOIDSMAN с приказом Conceal, но во время того counteract нельзя выполнять никакие действия, кроме Shoot, и для этого нужно использовать PRIVATEER SUPPORT ASSET."
            }
          ],
          "portrait": "img/portraits/elucidian-starstriders/voidsman.png"
        },
        {
          ...
          "weapons": [
            ...
            },
            {
              ...
              "hit": "4+",
              "dmg": "4/5",
              "wr": "Heavy (Dash only), Rending, Torrent 1\""
            },
            {
              "name": "Gun butt",
              "atk": 3,
          ...
          "portrait": "img/portraits/elucidian-starstriders/voidsman_rotor_cannon.png"
        }
      ],
      "poolPick": 0,
      "pool": [],
      "lore": {
        "intro": "Elucia Vhane — отпрыск благородной торговой династии. Оставив позади семейные владения на галактическом севере, Vhane повела свой отряд Elucidian Starstriders к Eastern Fringe. Вместе со своей эксцентричной командой дерзкая Rogue Trader стремится затмить богатую историю своих предков собственным восхождением к славе — или погибнуть, пытаясь.",
        "operatives": [
          {
            "name": "Elucia Vhane",
            "text": "Некогда капитан New Dawn, Rogue Trader Elucia Vhane происходит из древней династии. Семейная выучка отточила её врождённые лидерские качества, и в бою она владеет cane-rapier по имени Blur, сражаясь как мастер-дуэлянт. Она неизменно высматривает врагов при помощи мульти-спектрального ауспикатора."
          },
          {
            "name": "Canid",
            "text": "Бесчисленные линии Canid выводятся или выращиваются в чанах для охоты, атаки или устрашения, и многие Rogue Traders ценят это сочетание преданности и агрессии. Elucia Vhane назвала своего зверя Aximillion, и её Voidsmen-at-Arms обучают его как охранника и компаньона."
          },
          {
            "name": "Death Cult Executioner",
            "text": "Для Death Cult Executioner сам факт жизни — богохульство, уравновешиваемое лишь числом собранных душ. Они несут смерть в ближнем бою, владея множеством боевых стилей. Последователь Vhane, Death Cult Executioner Knosso Prond поклялся убить тысячу разных ксеносов."
          },
          {
            "name": "Lectro-Maester",
            "text": "Обладая связью с Motive Force, эти тех-жрецы — последователи Cult Mechanicus, способные создавать защитное voltagheist-поле при помощи механизма на спине. Lectro-Maester Larsen van der Grauss присоединился к экспедициям Vhane ради шанса на эзотерические открытия."
          },
          {
            "name": "Rejuvenat Adept",
            "text": "Эти операторы — мастера исцеления и продления жизни. Они применяют обезболивающие средства и проводят экстренные операции даже в самых чудовищных условиях. Rejuvenat Adept Sanistasia Minst присоединилась к Starstriders в своих одержимых поисках панацеи."
          },
          {
            "name": "Voidmaster",
            "text": "Voidmasters командуют отрядами флотской пехоты. Они рявкают команды, обеспечивая огневую дисциплину, и неукоснительно следуют Naval codes. Voidmaster Nitsch и его отряд были откомандированы к Vhane с боевого корабля Vengeance, а его храбрость под огнём стала легендарной."
          },
          {
            "name": "Voidsman",
            "text": "Voidsmen обычно служат на военных кораблях, уничтожая любого, кто угрожает их судну или экипажу. Облачённые в барочную броню, они удерживают врагов на расстоянии las-огнём. В отряде Voidmaster Nitsch ветеран Stromian Grell носит rotor cannon по праву своей стабильной меткости."
          },
          {
            "name": "Voidsman (Rotor Cannon)",
            "text": "Voidsmen обычно служат на военных кораблях, уничтожая любого, кто угрожает их судну или экипажу. Облачённые в барочную броню, они удерживают врагов на расстоянии las-огнём. В отряде Voidmaster Nitsch ветеран Stromian Grell носит rotor cannon по праву своей стабильной меткости."
      ...
      "factionRules": [
        {
          ...
          "text": "Мандат Rogue Trader даёт им невероятный доступ почти к любому другому агенту Империума — они торгуются, запугивают и «одалживают», чтобы добыть ценные ресурсы, позволяющие вступать в любое столкновение с преимуществом.\n\nДо четырёх раз за битву можно использовать правило WARRANT OF TRADE (см. ниже). Каждое из них указывает, когда его можно использовать, и нельзя использовать одно и то же правило WARRANT OF TRADE более одного раза за битву."
        },
        {
          "name": "Privateer Support Assets",
          "text": "Starstriders никогда не удаляются далеко от New Dawn. Наверху его массивные батареи корабельной артиллерии обрушиваются на врагов, обеспечивая бесценную огневую поддержку с воздуха.\n\nOnce per Firefight phase, когда дружественный оператор ELUCIDIAN STARSTRIDER NAVIS или ELUCIDIAN STARSTRIDER ELUCIA VHANE выполняет действие Shoot, можно выбрать одно из следующих дальнобойных орудий PRIVATEER SUPPORT ASSET для использования им. Каждый PRIVATEER SUPPORT ASSET нельзя использовать более одного раза за битву.\n\nКаждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER использует PRIVATEER SUPPORT ASSET, cover save определяется иначе. Вместо обычного правила, цель имеет cover save, если любая часть её базы находится под Vantage terrain. Обрати внимание, что хотя это влияет на cover save цели, всё равно нужно выбирать допустимую цель как обычно. Другими словами, выстрел наводится оператором в killzone, но прилетает сверху."
        },
        {
          "name": "Lethal Proximity",
          "text": "Каждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER стреляет по оператору в пределах 6\" от себя, дальнобойное оружие того дружественного оператора (кроме оружия PRIVATEER SUPPORT ASSET) получает weapon rule Balanced.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Stake Claim",
          "text": "Размести свой маркер Claim в killzone. Каждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER стреляет по, дерётся против или отвечает (retaliating) вражескому оператору в пределах 3\" от этого маркера, на шаге Roll Attack Dice можно удержать один из своих fail как normal success вместо того, чтобы отбросить его, либо удержать один из своих normal success как critical success. В конце turning point убери свой маркер Claim из killzone.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Undaunted Explorers",
          "text": "В первый раз за turning point, когда attack dice наносит урон каждому дружественному оператору ELUCIDIAN STARSTRIDER на шаге Resolve Attack Dice, можно уменьшить наносимый урон вдвое (округляя вверх, минимум 2).",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Quick March",
          "text": "Каждый раз, когда дружественный оператор ELUCIDIAN STARSTRIDER выполняет действие Reposition во время своей активации, можно использовать это правило. Если используешь: добавь 1\" к его Move stat до конца этой активации, но он должен закончить это движение ближе к drop zone противника и не может использовать PRIVATEER SUPPORT ASSET во время этой активации.",
          "cost": "Strategy Ploy"
        },
        {
          "name": "Combined Arms",
          "text": "Используй этот firefight ploy после броска attack dice дружественным оператором ELUCIDIAN STARSTRIDER, если он стреляет по вражескому оператору, по которому уже стрелял другой дружественный оператор ELUCIDIAN STARSTRIDER в этом turning point. Можно перебросить любые свои attack dice. Нельзя использовать этот ploy, стреляя PRIVATEER SUPPORT ASSET.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Survivalist",
          "text": "Используй этот firefight ploy, когда активируется дружественный оператор ELUCIDIAN STARSTRIDER. Тот дружественный оператор восстанавливает до D3+2 потерянных wounds, и во время этой активации можно игнорировать любые изменения его APL stat.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Great Endurance",
          "text": "Используй этот firefight ploy во время активации дружественного оператора ELUCIDIAN STARSTRIDER NAVIS. До конца активации добавь 1 к его APL stat.",
          "cost": "Firefight Ploy"
        },
        {
          "name": "Well-Drilled",
          "text": "Используй этот firefight ploy, когда активируется дружественный оператор ELUCIDIAN STARSTRIDER NAVIS. Выбери другого готового (ready) дружественного оператора ELUCIDIAN STARSTRIDER NAVIS, видимого и в пределах 3\" от того оператора. Когда первый дружественный оператор станет expended, можно активировать того другого дружественного оператора прежде, чем активируется противник. Когда тот другой оператор станет expended, противник активируется как обычно.",
          "cost": "Firefight Ploy"
        }
      ],
      "factionChoices": [
          ...
          "options": [
            {
              "id": "consideration",
              "name": "Consideration",
              "text": "Когда: на шаге Select Operatives, после раскрытия вариантов снаряжения. Эффект: выбери один дополнительный вариант снаряжения. Он не может быть вариантом, который ты уже выбирал."
            },
            {
              "id": "coordinate",
              "name": "Coordinate",
              "text": "Когда: в конце шага Select Operatives. Эффект: получи 1 дополнительное CP."
            },
            {
              "id": "coerce",
              "name": "Coerce",
              "text": "Когда: в начале шага Set Up Operatives. Эффект: противник должен расставить всё своё снаряжение прежде, чем ты расставишь своё. Кроме того, выбери один из следующих вариантов:\n• Противник должен расставить всех своих операторов прежде, чем ты расставишь своих.\n• Ты можешь расставить всё своё снаряжение прежде, чем противник расставит своё."
            },
            {
              "id": "explore",
              "name": "Explore",
              "text": "Когда: Strategic Gambit в первый turning point. Эффект: выполни бесплатное действие Reposition для D3 дружественных операторов ELUCIDIAN STARSTRIDER, полностью находящихся в пределах твоей drop zone. Каждый из них должен закончить это движение полностью в пределах 4\" от твоей drop zone."
            },
            {
              "id": "bribe",
              "name": "Bribe",
              "text": "Когда: наступает твой черёд активировать оператора. Эффект: можешь пропустить эту активацию."
            },
            {
              "id": "seize",
              "name": "Seize",
              "text": "Когда: в Strategy phase, после броска за инициативу. Эффект: можешь перебросить свой кубик."
            },
            {
              "id": "adaptable_terms",
              "name": "Adaptable Terms",
              "text": "Только для Approved Ops. Когда: в конце второго turning point. Эффект: выбери новый tac op или новый primary op. Если выбираешь новый tac op, все очки, набранные по предыдущему tac op, аннулируются."
            }
          ]
        },
        {
          "id": "privateer_support_assets",
          "label": "Privateer Support Assets",
          "scope": "game",
          "pick": 5,
          "options": [
            {
              ...
              "text": "Atk 4, Hit 3+, Dmg 6/7, wr Heavy (Reposition only), Piercing 2, Silent. Используется один раз за битву вместо обычного действия Shoot оператором NAVIS или Elucia Vhane."
            },
            {
              "id": "plasma_battery",
              "name": "Plasma battery",
              "text": "Atk 5, Hit 4+, Dmg 5/6, wr Heavy (Reposition only), Lethal 5+, Piercing 1, Silent. Используется один раз за битву вместо обычного действия Shoot оператором NAVIS или Elucia Vhane."
            },
            {
              "id": "macrocannon",
              "name": "Macrocannon",
              "text": "Atk 5, Hit 4+, Dmg 4/5, wr Heavy (Reposition only), Piercing Crits 1, Saturate, Torrent 2\". Используется один раз за битву вместо обычного действия Shoot оператором NAVIS или Elucia Vhane."
            },
            {
              "id": "guided_shell",
              "name": "Guided shell",
              "text": "Atk 5, Hit 4+, Dmg 3/4, wr Blast 2\", Heavy (Reposition only), Silent. Используется один раз за битву вместо обычного действия Shoot оператором NAVIS или Elucia Vhane."
            },
            {
              "id": "cluster_bomb",
              "name": "Cluster bomb",
              "text": "Atk 5, Hit 4+, Dmg 2/3, wr Blast 3\", Heavy (Reposition only), Silent. Используется один раз за битву вместо обычного действия Shoot оператором NAVIS или Elucia Vhane."
            }
          ]
        }
      ],
      "statusTokens": [
        {
          "id": "voltagheist_charge",
          "name": "Calibrate Voltagheist: Charge",
          "target": "friendly",
          "text": "Отмечает оператора, выбравшего эффект Charge действия Calibrate Voltagheist. Voltaic pistol этого оператора имеет weapon rule Lethal 4+ до начала его следующей активации, до его incapacitation или до повторного выполнения действия Calibrate Voltagheist (что наступит раньше)."
        },
        {
          "id": "voltagheist_field",
          "name": "Calibrate Voltagheist: Field",
          "target": "friendly",
          "text": "Отмечает оператора, выбравшего эффект Field действия Calibrate Voltagheist. До начала следующей активации этого оператора, до его incapacitation или до повторного выполнения действия Calibrate Voltagheist (что наступит раньше) — каждый раз, когда вражеский оператор заканчивает действие Charge, Dash, Fall Back или Reposition, будучи видимым этому оператору и в пределах 4\" от него, нанеси D6 урона тому вражескому оператору."
        }
      ]
    },
    "Blooded": {
      ...
      "required": [
        {
          ...
          "abilities": [
            {
              "name": "Weapon Choice",
              "text": "В официальных правилах для этого оператора выбирается один вариант вооружения при сборке ростера:\n• Autopistol или Laspistol; Chainsword или Power weapon\n• Bolt pistol; Chainsword\n• Boltgun; Bayonet\n• Plasma pistol; Improvised blade (в этом случае команда не может включать GUNNER с plasma gun — в команде может быть только один оператор с плазменным оружием)\n\nВ этом приложении представлены все варианты вооружения; используй только выбранный."
            },
            {
              "name": "Blooded Icon",
              "text": "Once per turning point, когда дружественный оператор BLOODED, у которого есть один из твоих токенов Blooded, выведен из строя, если этот оператор в пределах 6\" от него, ты можешь вернуть себе тот токен."
            },
            {
              "name": "Lead With Strength",
              "text": "Каждый раз, когда у этого оператора есть один из твоих токенов Blooded или он целиком находится на территории противника, считай, что он под GAZE OF THE GODS."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_chieftain.png"
        }
      ],
      "poolPick": 9,
      "pool": [
        {
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/3",
              "wr": "Range 6\", Blast 2\", Devastating 2, Limited 1, Heavy (Reposition only), Piercing 1, Saturate"
            },
            {
              "name": "Lasgun",
              "atk": 4,
          ...
          "abilities": [
            {
              "name": "Grenadier",
              "text": "Может использовать frag и krak гранаты (universal equipment). Их использование не учитывается в лимит применений (то есть если ты также выбрал те же гранаты из снаряжения для других операторов). Каждый раз, когда использует их, улучшает Hit stat этого оружия на 1."
            },
            {
              "name": "Explosive Demise",
              "text": "Если этот оператор выведен из строя, до того как он будет убран из killzone, можно использовать это правило. Если используешь: брось два D6, или один D6, если этот оператор в пределах control range вражеского оператора. Если какой-либо результат 4+, нанеси D3+2 урона каждому оператору, видимому этому оператору и в пределах 2\" от него (бросок отдельно для каждого). Если этот оператор не использовал свою diabolyk bomb за битву, нанеси D6+2 урона вместо этого."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_brimstone_grenadier.png"
        },
        {
          ...
          "weapons": [
            {
              ...
              "hit": "3+",
              "dmg": "4/6",
              "wr": "Ceaseless, Lethal 5+, Blood Offering*"
            }
          ],
          "abilities": [
            {
              "name": "Unholy Sustenance",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating), если в этой последовательности он выводит из строя вражеского оператора, он восстанавливает до D3 потерянных wounds. Суммируется с эффектом снаряжения Symbols of Bloody Worship."
            },
            {
              "name": "*Blood Offering",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating) этим оружием, в первый раз, когда он наносит удар с critical success за эту последовательность, ты получаешь один токен Blooded."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_butcher.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Signal",
              "text": "SUPPORT. Выбери другого дружественного оператора BLOODED (кроме OGRYN), видимого этому оператору и в пределах 6\" от него. До конца следующей активации того оператора прибавь 1 к его APL stat.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            },
            {
              "name": "Sacrilegious Activation",
              "text": "Ты получаешь один токен Blooded.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора, или если у него нет одного из твоих токенов Blooded.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/blooded/traitor_commsman.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Regular Dosage",
              "text": "В конце шага Select Operatives, если этот оператор выбран для развёртывания, ты можешь выбрать одного другого дружественного оператора BLOODED, чтобы он получил на битву одно из STIMM Rules (кроме Rejuvenated)."
            },
            {
              "name": "STIMM Rules",
              "text": "• Rejuvenated: оператор восстанавливает до 2D3 потерянных wounds.\n• Enraged: оружие ближнего боя оператора получает weapon rule Relentless.\n• Fortified: каждый раз, когда attack dice наносит этому оператору 3 или больше урона, брось один D6: на 5+ вычти 1 из этого урона."
            },
            {
              "name": "Stimms",
              "text": "Выбери одного дружественного оператора BLOODED в пределах control range этого оператора, затем выбери для него Rejuvenated STIMM rule, либо одно другое STIMM rule на битву. Нельзя выбрать одно и то же STIMM rule одному и тому же оператору более одного раза за битву.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/blooded/traitor_corpseman.png"
        },
        {
          ...
          "abilities": [
            {
              ...
              "text": "• Каждый раз, когда дружественный оператор BLOODED находится в пределах 6\" от этого оператора, можно игнорировать любые изменения его характеристик от полученных повреждений (включая характеристики его оружия).\n• Каждый раз, когда дружественный оператор BLOODED активируется в пределах 6\" от этого оператора, можно игнорировать любые изменения его характеристик от полученных повреждений до конца его активации (включая характеристики его оружия)."
            },
            {
              "name": "Enforce",
              "text": "Выбери другого дружественного оператора BLOODED, видимого этому оператору и в пределах 3\" от него. Тот оператор может немедленно бесплатно выполнить действие за 1AP, но не может переместиться больше чем на 2\" во время этого действия. Если выбранный дружественный оператор — COMMSMAN, он не может выполнить действия Sacrilegious Activation или Signal.\n\nЭтот оператор не может выполнять это действие, находясь в пределах control range вражеского оператора.",
              "cost": "1AP"
            }
          ],
          "portrait": "img/portraits/blooded/traitor_enforcer.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "*Stalk",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating) этим оружием, если Light или Heavy terrain находится в пределах его control range, это оружие получает weapon rule Lethal 5+."
            },
            {
              "name": "Wretched",
              "text": "Этот оператор может выполнить действие Charge, даже имея приказ Conceal. Если этот оператор выведен из строя во время действия Fight, он может нанести удар по вражескому оператору в этой последовательности одним из своих неразрешённых успехов, прежде чем этот оператор будет убран из killzone."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_flenser.png"
        },
        {
          "name": "Traitor Gunner (Flamer)",
          "apl": 2,
          "move": "6\"",
          "save": "5+",
          "wounds": 7,
          ...
          "abilities": [
            {
              "name": "Pool Limit",
              "text": "Ограничение выбора в пул: суммарно из вариантов GUNNER (любые варианты вооружения) и SHARPSHOOTER можно выбрать в команду не более 3 операторов."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_gunner_flamer.png"
        },
        {
          "name": "Traitor Gunner (Grenade Launcher)",
          "apl": 2,
          "move": "6\"",
          "save": "5+",
          "wounds": 7,
          ...
          "portrait": "img/portraits/blooded/traitor_gunner_grenade_launcher.png"
        },
        {
          "name": "Traitor Gunner (Meltagun)",
          "apl": 2,
          "move": "6\"",
          "save": "5+",
          "wounds": 7,
          ...
          "portrait": "img/portraits/blooded/traitor_gunner_meltagun.png"
        },
        {
          "name": "Traitor Gunner (Plasma Gun)",
          "apl": 2,
          "move": "6\"",
          "save": "5+",
          "wounds": 7,
          ...
          "abilities": [
            {
              "name": "Pool Limit",
              "text": "Ограничение выбора в пул: суммарно из вариантов GUNNER (любые варианты вооружения) и SHARPSHOOTER можно выбрать в команду не более 3 операторов. Нельзя выбрать этого оператора, если TRAITOR CHIEFTAIN вооружён plasma pistol — в команде может быть только один оператор с плазменным оружием."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_gunner_plasma_gun.png"
        },
        {
          "name": "Traitor Ogryn",
          "apl": 2,
          ...
          "abilities": [
            {
              ...
              "text": "Каждый раз, когда этот оператор заканчивает своё движение во время действия Charge, он может нанести D3 урона одному вражескому оператору в пределах его control range."
            },
            {
              "name": "Chem-enhanced",
              "text": "Можно игнорировать любые изменения APL stat этого оператора, и на него не действуют weapon rules Shock и Stun вражеского оружия."
            },
            {
              "name": "Brute",
              "text": "Каждый раз, когда твой оппонент выбирает допустимую цель, если у этого оператора приказ Conceal, он не может использовать Light terrain для укрытия. Хотя это может сделать его допустимой целью (если он видим), это не убирает его cover save (если он есть)."
            },
            {
              "name": "Slow-witted",
              "text": "Нужно тратить на 1AP больше, чтобы этот оператор выполнил действие Pick Up Marker и mission-действия (кроме Operate Hatch)."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_ogryn.png"
        },
        {
          ...
          "weapons": [
            ...
            },
            {
              ...
              "hit": "2+",
              "dmg": "3/3",
              "wr": "Devastating 1, Heavy (Dash only), Silent"
            },
            {
              "name": "Bayonet",
              "atk": 3,
          ...
          "abilities": [
            ...
            {
              "name": "Camo Cloak",
              "text": "Каждый раз, когда оператор стреляет по этому оператору, если можно удержать любые cover save, можно удержать один дополнительный cover save. Не суммируется с улучшенными cover save от Vantage terrain."
            },
            {
              "name": "A Name Whispered In Blood",
              "text": "STRATEGIC GAMBIT в первый turning point. Выбери одного вражеского оператора. Каждый раз, когда этот оператор стреляет по тому вражескому оператору, считай, что у того есть один из твоих токенов Blooded и что он под GAZE OF THE GODS."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_sharpshooter.png"
        },
        {
          "name": "Traitor Thug",
          "apl": 2,
          ...
          "abilities": [
            {
              "name": "Tough",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating), или оператор стреляет по нему, Normal Dmg 3 или больше наносит ему на 1 урона меньше."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_thug.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "*Shield",
              "text": "Каждый раз, когда этот оператор дерётся или отвечает (retaliating) этим оружием, каждый его блок может распределяться на два неразрешённых успеха (вместо одного)."
            },
            {
              "name": "Shielding",
              "text": "Каждый раз, когда этот оператор активируется, можно использовать это правило. Если используешь, до начала следующей активации этого оператора:\n• Вычти 2\" из его Move stat.\n• Каждый раз, когда оператор стреляет по этому оператору, можно перебросить любые его defence dice."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_trench_sweeper.png"
        },
        {
          ...
          "abilities": [
            {
              "name": "Group Activation",
              "text": "Каждый раз, когда этот оператор становится expended, ты должен затем активировать (если можешь) одного другого готового дружественного оператора BLOODED TROOPER, прежде чем активируется оппонент. Когда тот другой оператор становится expended, оппонент активируется как обычно (иными словами, нельзя активировать этим правилом более двух операторов подряд)."
            }
          ],
          "portrait": "img/portraits/blooded/traitor_trooper.png",
          "maxCopies": 9
        }
      ],
      "lore": {
        "intro": "Blooded — это разрозненные банды отступников и еретиков, бросающие себя в бой в тщетной надежде заслужить внимание малефичных сущностей варпа. Каждая пролитая капля крови — подношение Тёмным Богам; каждая победа над сильным противником — шанс быть отмеченным токеном Blooded и оказаться под Gaze of the Gods. Многие из них падут прежде, чем получат награду — но даже их гибель, полная ярости и ненависти, служит подношением.",
        "operatives": [
          {
            "name": "Traitor Chieftain",
            "text": "Вожак банды, ведущий своих людей вглубь вражеской территории личным примером — чем ближе к врагу он стоит, тем очевиднее его благословение Тёмными Богами."
          },
          {
            "name": "Traitor Brimstone Grenadier",
            "text": "Носитель самодельной diabolyk bomb, готовый унести с собой в посмертие как можно больше врагов, если его собственная жизнь окажется на исходе."
          },
          {
            "name": "Traitor Butcher",
            "text": "Мясник банды, чьё изогнутое силовое лезвие не знает пощады — каждый критический удар в резне становится новым подношением Тёмным Богам."
          },
          {
            "name": "Traitor Corpseman",
            "text": "Полевой знахарь, чьи самодельные стимуляторы одинаково легко и исцеляют, и превращают сородичей в берсерков."
          },
          {
            "name": "Traitor Commsman",
            "text": "Связист банды, передающий команды по украденной военной рации — и первым бросающийся исполнять сакрилегиозные ритуалы во имя своих покровителей."
          },
          {
            "name": "Traitor Enforcer",
            "text": "Надсмотрщик, силовым кулаком поддерживающий дисциплину среди Blooded — под его присмотром раненые сородичи сражаются так, будто ничего не случилось."
          },
          {
            "name": "Traitor Flenser",
            "text": "Мастер разделочных клинков, скрывающийся среди теней и террейна, чтобы выйти на удар с абсолютной летальностью."
          },
          {
            "name": "Traitor Gunner (Flamer)",
            "text": "Тяжёлое вооружение банды, выжигающее укрытия противника струёй promethium."
          },
          {
            "name": "Traitor Gunner (Grenade Launcher)",
            "text": "Носитель гранатомёта, засыпающий позиции врага фраг- и крак-снарядами."
          },
          {
            "name": "Traitor Gunner (Meltagun)",
            "text": "Специалист по meltagun, прожигающий броню самых стойких целей на поле боя."
          },
          {
            "name": "Traitor Gunner (Plasma Gun)",
            "text": "Оператор плазменного орудия — редкое и опасное сокровище банды, способное испепелить даже элитного противника ценой риска для самого стрелка."
          },
          {
            "name": "Traitor Ogryn",
            "text": "Приручённый (насколько это возможно) абхуман-громила, чья сила крушит врагов и укрепления с равной лёгкостью."
          },
          {
            "name": "Traitor Sharpshooter",
            "text": "Снайпер банды, отмечающий обречённую жертву задолго до того, как та узнает о своей участи."
          },
          {
            "name": "Traitor Thug",
            "text": "Головорез с тяжёлой дубиной, чья прочная шкура выдерживает удары, способные свалить менее закалённого бойца."
          },
          {
            "name": "Traitor Trench Sweeper",
            "text": "Боец с дробовиком и щитом, зачищающий траншеи и узкие проходы плотным огнём в упор."
          },
          {
            "name": "Traitor Trooper",
            "text": "Рядовой боец банды — таких много, и каждый готов идти в бой следом за товарищем без колебаний."
          }
        ]
      },
      "factionRules": [
        {
          "name": "Blooded",
          "text": "Blooded ищут благосклонности малефичных сущностей варпа, бросаясь в бой против сильнейших противников. Даже гибнущие в этой попытке служат достойным подношением.\n\nТы получаешь один токен Blooded:\n• На шаге Ready каждой Strategy phase.\n• В первый раз, когда вражеский оператор выведен из строя в этом turning point.\n• В первый раз, когда дружественный оператор выведен из строя в пределах 6\" от вражеского оператора в этом turning point.\n\nКак STRATEGIC GAMBIT, ты можешь распределить любые из своих неназначенных токенов Blooded между дружественными операторами BLOODED. У оператора не может быть больше одного твоего токена Blooded. Затем, если четыре или более дружественных оператора в killzone имеют твой токен Blooded, можно выбрать одного из них, чтобы он оказался под GAZE OF THE GODS до конца turning point.\n\nКаждый раз, когда у дружественного оператора BLOODED есть твой токен Blooded, его оружие получает weapon rule Accurate 1. Если тот дружественный оператор BLOODED под GAZE OF THE GODS, можно сохранить один normal success от weapon rule Accurate 1 как critical success вместо него."
        },
        {
          "name": "Glory Kill",
          "cost": "Strategy Ploy",
          "text": "Уничтожая сильнейших и способнейших врагов, Blooded могут преподнести достойное подношение Разрушительным Силам.\n\nВыбери одного вражеского оператора. До конца turning point, каждый раз, когда дружественный оператор BLOODED стреляет по, дерётся против или отвечает (retaliating) против того вражеского оператора, оружие этого стреляющего/дерущегося/отвечающего оператора получает weapon rule Ceaseless, либо Relentless, если у него есть один из твоих токенов Blooded."
        },
        {
          "name": "Reckless Aspirant",
          "cost": "Strategy Ploy",
          "text": "Трус не заслужит славы. Blooded готовы рисковать жизнью и телом ради благосклонности малефичных сил.\n\nКаждый раз, когда дружественный оператор BLOODED, целиком находящийся на территории противника и не имеющий твоего токена Blooded, стреляет или дерётся, его оружие получает weapon rule Accurate 1.\n\nКаждый раз, когда дружественный оператор BLOODED с твоим токеном Blooded целиком находится на территории противника, его оружие получает weapon rule Punishing."
        },
        {
          "name": "Malevolent Grit",
          "cost": "Strategy Ploy",
          "text": "Те, кто заслужил благосклонность Тёмных Богов Хаоса, могут черпать из варпа силу, чтобы предвидеть и избегать вражеских выстрелов.\n\nКаждый раз, когда оператор стреляет по дружественному оператору BLOODED с твоим токеном Blooded или целиком находящемуся на территории противника, можно перебросить один из своих defence dice."
        },
        {
          "name": "Bitter Demise",
          "cost": "Strategy Ploy",
          "text": "Охваченные ненавистью, Blooded плюются, проклинают и наносят последний удар, выкрикивая слова ереси, пока умирают.\n\nКаждый раз, когда дружественный оператор BLOODED выведен из строя, до того как он будет убран из killzone, брось один D3: при результате 3 (или 2+, если у того дружественного оператора есть твой токен Blooded), нанеси урон, равный результату, одному вражескому оператору, видимому этому дружественному оператору и в пределах 2\" от него."
        },
        {
          "name": "Callous Disregard",
          "cost": "Firefight Ploy",
          "text": "Жалость — черта слабых. Blooded с радостью направят оружие на своих же, если это гарантирует уничтожение врага.\n\nИспользуй этот firefight ploy, когда дружественный оператор BLOODED выполняет действие Shoot и ты выбираешь допустимую цель. Наличие других дружественных операторов BLOODED в пределах control range вражеского оператора не мешает выбрать того вражеского оператора целью. До конца этого действия, каждый раз, когда ты отбрасываешь attack dice как fail, нанеси урон, равный результату кубика, одному дружественному оператору на твой выбор в пределах control range цели."
        },
        {
          "name": "Moment of Repute",
          "cost": "Firefight Ploy",
          "text": "Наделённые частицей силы Тёмных Богов, Blooded обретают инфернальную скорость и агрессию.\n\nИспользуй этот firefight ploy во время активации дружественного оператора BLOODED, находящегося под GAZE OF THE GODS, до или после выполнения им действия. До конца активации этого оператора прибавь 1 к его APL stat."
        },
        {
          "name": "Reward Earned",
          "cost": "Firefight Ploy",
          "text": "Верный способ привлечь внимание Разрушительных Сил — пролить кровь во имя них.\n\nИспользуй этот firefight ploy, когда вражеский оператор выведен из строя дружественным оператором BLOODED с твоим токеном Blooded, находящимся в пределах 2\" от него. Ты получаешь один токен Blooded."
        },
        {
          "name": "Dark Favour",
          "cost": "Firefight Ploy",
          "text": "Те, кто пролил вражескую кровь и заслужил благосклонность своего инфернального покровителя, могут быть избавлены от смерти — если за них заплатит другой.\n\nИспользуй этот firefight ploy, когда дружественный оператор BLOODED с твоим токеном Blooded выбран допустимой целью действия Shoot либо противником для действия Fight. Выбери другого дружественного оператора BLOODED, видимого этому первому дружественному оператору и в пределах 3\" от него, чтобы он стал допустимой целью или противником вместо него (даже если он обычно не подходил бы для этого). Если это действие Fight, считай того другого оператора находящимся в пределах control range дерущегося оператора на время этого действия. Если это действие Shoot, тот другой оператор считается в укрытии или obscured, только если исходная цель была такой.\n\nЭтот ploy не имеет эффекта, если это действие Shoot и дальнобойное оружие имеет weapon rule Blast или Torrent."
        }
      ],
      "statusTokens": [
        {
          ...
          "name": "Blooded Token",
          "target": "friendly",
          "text": "Отмечает дружественного оператора BLOODED, у которого есть один из твоих токенов Blooded (у оператора не может быть больше одного). Пока у оператора есть этот токен, его оружие получает weapon rule Accurate 1."
        },
        {
          "id": "gaze_of_the_gods",
          "name": "Gaze of the Gods",
          "target": "friendly",
          "text": "Под этим эффектом одновременно может находиться только один оператор; действует до конца turning point. Если у оператора под Gaze of the Gods есть токен Blooded, можно сохранить один normal success от weapon rule Accurate 1 как critical success вместо него."
        },
        {
          "id": "name_whispered_in_blood",
          "name": "A Name Whispered in Blood",
          "target": "enemy",
          "text": "Назначается через STRATEGIC GAMBIT оператора Sharpshooter в первый turning point (правило A Name Whispered In Blood). Каждый раз, когда назначивший его Sharpshooter стреляет по отмеченному оператору, считай, что у того есть токен Blooded и что он под Gaze of the Gods."
        },
        {
          "id": "shielding",
          "name": "Shielding",
          "target": "friendly",
          "text": "Самобаф оператора Trench Sweeper (правило Shielding), действует до начала его следующей активации: Move stat снижен на 2\"; каждый раз, когда оператор стреляет по нему, можно перебросить любые его defence dice."
        },
        {
          "id": "enraged",
          "name": "Enraged (Stimm)",
          "target": "friendly",
          "text": "Получен через действие Stimms оператора Corpseman. Оружие ближнего боя этого оператора получает weapon rule Relentless на всю битву."
        },
        {
          "id": "fortified",
          "name": "Fortified (Stimm)",
          "target": "friendly",
          "text": "Получен через действие Stimms оператора Corpseman. Каждый раз, когда attack dice наносит этому оператору 3 или больше урона, брось один D6: на 5+ вычти 1 из этого урона."
        }
      ]
    }
  }
