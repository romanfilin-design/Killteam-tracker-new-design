...
(function () {
  ...
  var TOTAL_KILL_TEAMS_PLANNED = 48;
  ...
  var TERM_GLOSSARY = {
    ...
    'Aimed': 'Aimed — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Aimed»).',
    ...
    'Blaze': 'Blaze — особое правило фракции про горящих операторов и токены Blaze; полное описание — в правиле фракции этой команды.',
    'Twin Torrent': 'Twin Torrent — особое правило конкретного оружия; полное описание — в способностях этого оператора.',
    'Wreathed': 'Wreathed — особое правило конкретного оружия; полное описание — в способностях этого оператора.',
    'Soulstrike': 'Soulstrike — особое правило фракции, меняющее определение успехов/провалов кубиков защиты в зависимости от APL цели; полное описание — в правиле фракции этой команды.',
    ...
    'Neutron Fragment': 'Neutron Fragment — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Neutron Fragment»).',
    'Neutron Bombardment': 'Neutron Bombardment — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Neutron Bombardment»).',
    'Skytorch': 'Skytorch — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Skytorch»).',
    'Detonate': 'Detonate — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Detonate»).',
    'Smash': 'Smash — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Smash»).',
    'Humbling Cruelty': 'Humbling Cruelty — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Humbling Cruelty»).',
    'Pulsa': 'Pulsa — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Pulsa»).',
    'Hypersense': 'Hypersense — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Hypersense»).',
    'Custom': 'Custom — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Custom»).',
    'Phase Sweep': 'Phase Sweep — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «Phase Sweep*»).',
    'Swipe': 'Swipe — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Swipe»).',
    'Feast': 'Feast — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Feast»).',
    'Engineered': 'Engineered — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Engineered»).',
    'Tangle': 'Tangle — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Tangle»).',
    'Stinger': 'Stinger — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Stinger»).',
    'Flay': 'Flay — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Flay»).',
    'Bipod': 'Bipod — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «* Bipod»).',
    'Ritual': 'Ritual — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Ritual»).',
    'Drag': 'Drag — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Drag»).',
    'Prey': 'Prey — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «*Prey»).',
    'Crush': 'Crush — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «Crush*»).',
    'Siphon Life': 'Siphon Life — особое правило конкретного оружия; полное описание — в способностях этого оператора (ищи запись «Siphon Life*»).',
  };
